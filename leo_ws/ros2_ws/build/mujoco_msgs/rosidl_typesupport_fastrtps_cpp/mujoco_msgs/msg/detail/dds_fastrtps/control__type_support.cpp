...
#include "mujoco_msgs/msg/detail/control__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mujoco_msgs
cdr_serialize(
  const mujoco_msgs::msg::Control & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mujoco_msgs::msg::Control & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mujoco_msgs::msg::Control;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mujoco_msgs::msg::Control *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mujoco_msgs::msg::Control *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_mujoco_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<mujoco_msgs::msg::Control>()
{
  return &mujoco_msgs::msg::typesupport_fastrtps_cpp::_Control__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mujoco_msgs, msg, Control)() {
  return &mujoco_msgs::msg::typesupport_fastrtps_cpp::_Control__handle;
}
